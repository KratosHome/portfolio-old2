  ...
  return (
    <>
      ...
      <div className="relative mx-auto max-w-[1842px]">
        <div
          className="animate-scale-in-out absolute -right-[50px] -top-[170px] -z-10 hidden h-[300px] w-[300px] bg-cover bg-center bg-group-pattern-light dark:bg-group-pattern dark:opacity-[.1] lg:block" />
      </div>
    </>
  )
}
